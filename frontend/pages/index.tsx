...
export default function LandingPage() {
  return (
    <>
      <Head>
        <title>SmartBin | Intelligent Waste Management</title>
      </Head>
        ...
        <div className="relative z-10 max-w-4xl w-full flex flex-col items-center">
          ...
          <div className="text-center mb-16 animate-fade-in-down">
            ...
            <h1 className="text-5xl md:text-6xl font-extrabold text-slate-900 tracking-tight mb-4">
              Smart<span className="text-green-600">Bin</span> System
            </h1>
            <p className="text-lg text-slate-500 max-w-lg mx-auto leading-relaxed">
              ระบบจัดการขยะอัจฉริยะเพื่อเมืองที่ยั่งยืน<br/>กรุณาเลือกส่วนงานที่คุณต้องการเข้าถึง
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-3xl">
            ...
            <Link href="/admin" legacyBehavior>
              <a className="group relative bg-white rounded-3xl p-8 shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-100 hover:border-blue-200 hover:-translate-y-1 overflow-hidden">
                <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-32 w-32 text-blue-600 transform rotate-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="relative z-10">
                  ...
                  <h2 className="text-2xl font-bold text-slate-800 mb-2 group-hover:text-blue-700 transition-colors">Admin Portal</h2>
                  <p className="text-slate-500 mb-6 text-sm leading-relaxed">
                    ระบบจัดการส่วนกลาง ดู Dashboard ภาพรวม<br/>ตรวจสอบสถานะ และจัดการอุปกรณ์
                  </p>
            ...
            <Link href="/collector" legacyBehavior>
              <a className="group relative bg-white rounded-3xl p-8 shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-100 hover:border-green-200 hover:-translate-y-1 overflow-hidden">
                <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-32 w-32 text-green-600 transform -rotate-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="relative z-10">
                  ...
                  <h2 className="text-2xl font-bold text-slate-800 mb-2 group-hover:text-green-700 transition-colors">Collector App</h2>
                  <p className="text-slate-500 mb-6 text-sm leading-relaxed">
                    สำหรับพนักงานขับรถเก็บขยะ<br/>ดูรายการงาน เส้นทาง และจุดที่ต้องเข้าเก็บ
                  </p>
          ...
          <div className="mt-16 text-center">
            <p className="text-slate-400 text-sm font-medium">© 2025 SmartBin Project. All rights reserved.</p>
          </div>
        </div>
      </div>
    </>
